...
<div class="left" id="LeftBox">
	<div class="left_1">
		<div class="left_1_c" ><?php if($_SESSION['userid']==''){ echo '&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<b> <a href="../register.html"> <b><font color=blue>注册</font><b></a>  |<a href="../index.html"><b><font color=blue> 登陆</a></font></b>';}elseif( $_SESSION['isadmin'] == '1' ){ echo "当前用户：<font color='red'>".$_SESSION['userid']."</font>(超级管理员)";}else{  echo "当前用户：<font color='red'>".$_SESSION['userid']."</font>(普通用户)";}?></div>
	</div>
	<div class="left_2">
...
<div style="text-align:center;font-family:\5fae\8f6f\96c5\9ed1;clear:both;">&nbsp;&nbsp;&nbsp;
  <p>Copyright &copy 2015.6 Worldventures | Dreamtrips All rights reserved. Powered by <a  href="mailto:509447546@qq.com">ZhangQuansheng &nbsp;&nbsp;&nbsp; wechat： 509447546 </p>
  <p>&nbsp;</p>
</div>
<div align="center">
<script type="text/javascript">var cnzz_protocol = (("https:" == document.location.protocol) ? " https://" : " http://");document.write(unescape("%3Cspan id='cnzz_stat_icon_1258757006'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "s95.cnzz.com/z_stat.php%3Fid%3D1258757006%26show%3Dpic' type='text/javascript'%3E%3C/script%3E"));</script>
</div>
</body>
