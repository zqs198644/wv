...
if ( $action == 'search'){
		...
		$profit_sql = "select s.category as category, sum(money) as money,sum(money-(money/price)*cost) as profit,(sum(money-(money/price)*cost)/sum(money)) as percent from sale s, category c where s.category = c.category and datetime between '".$start."' and  '".$end."' group by s.category order by percent desc limit 15";
...
<table width="384" border="1" class="table2">
  <tr>
    <th width="168" bgcolor="#CCCCCC" scope="col">利润最高TOP10<br /></th>
    <th width="60" bgcolor="#CCCCCC" scope="col">金额</th>
    <th width="68" bgcolor="#CCCCCC" scope="col">利润</th>
    <th width="60" bgcolor="#CCCCCC" scope="col">百分比</th>
  </tr>
<?php
...
?>
	...
	<td align="center"><font color="red"><?php echo round("$result[percent]",2)*100?> </font>% </td>
	</tr>
<?php
}
?> 
