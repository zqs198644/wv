...
switch($action) 
{
	case "change":
			if( $passwd_one == $passwd_two){
				 mysql_query("update members set password = '".md5($passwd_one)."' where userid = '".$_SESSION[userid]."'") or die(mysql_error());
...
<form id="form1" name="form1" method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>?action=change" onsubmit="return checkdata()">
  <table width="352" height="154" align='center' class='table_style' ellpadding='0' >
    ...
    <tr>
      <td width="118" height="24" align="center">会员ID：</td>
      <td width="230" align="left" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $_SESSION["userid"]?></td>
    </tr>
    <tr>
